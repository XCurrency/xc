...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the blocknetdx unit tests or QA tests
...
confused with overall XCurrency Network Protocol consensus changes.
...
Patches that change XCurrency consensus rules are considerably more involved than
...
Where a patch set proposes to change the XCurrency consensus, it must have been
