...
This means one can have an always-on xc3d instance running, and another local xc3d/xc3-qt instance which connects to this node and receives blocks from it.
