...
- [Building XCurrency](#building-blocknetdx)
...
Clone the git repositories for blocknetdx and gitian and then checkout the blocknetdx version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/blocknetdx-crypto/blocknetdx.git
cd blocknetdx
...
Follow the instructions in [doc/release-process.md](release-process.md) in the blocknetdx repository
...
```bash
    ...
    From https://github.com/blocknetdx-crypto/blocknetdx
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/blocknetdx-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/blocknetdx-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/blocknetdx-build.assert
```
...
[blocknetdx/gitian.sigs](https://github.com/blocknetdx-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
