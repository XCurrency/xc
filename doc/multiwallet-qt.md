...
In order to support loading of multiple wallets in xc3-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xc3.cpp.
...
Changes to xc3.cpp
----------------------
xc3.cpp is the entry point into xc3-qt, and as such, will require some minor modifications to provide hooks for
