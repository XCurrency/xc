TOR SUPPORT IN XCurrency
=======================

It is possible to run XCurrency as a Tor hidden service, and connect to such services.
...
Run XCurrency behind a Tor proxy
----------------------------------

The first step is running XCurrency behind a Tor proxy. This will already make all
...
```
-externalip=X   You can tell xcurrency about its publicly reachable address using
                this option, and this can be a .onion address. Given the above
                configuration, you can find your onion address in
                /var/lib/tor/xcurrency-service/hostname. Onion addresses are given
...
List of known XCurrency Tor relays
------------------------------------
```
