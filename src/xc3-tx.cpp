...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XCurrency Core xc3-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xc3-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xcurrency transaction") + "\n" +
                               "  xc3-tx [options] -create [commands]   " + _("Create hex-encoded xcurrency transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xcurrency transaction
