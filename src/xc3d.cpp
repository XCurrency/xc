 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called BlocknetDX (http://www.xcurrency.org),
...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/xcurrency.conf are parsed in qt/xc3.cpp's main()
    ...
    try {
        ...
        if (fCommandLine) {
            fprintf(stderr, "Error: There is no RPC client functionality in xc3d anymore. Use the xc3-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
